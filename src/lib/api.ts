...
export const chatsApi = {
  ...
  uploadMedia: (chat_id: number, data: string, mime_type: string, msg_type: string, text: string, filename = "") =>
    call(CHATS_URL, "upload_media", "POST", { chat_id, data, mime_type, msg_type, text, filename }),
